		...
		makepot     : {
			pot: {
				options: {
					cwd        : '..',
					exclude    : [ 'resources' ],
					mainFile   : 'linked-taxonomies.php',
					potComments: 'Copyright (C) {{year}} Linked Taxonomies\nThis file is distributed under the same license as the Linked Taxonomies package.',
					potFilename: '<%= globalConfig.textdomain %>.pot',
					potHeaders : {
						poedit                 : true,
						'report-msgid-bugs-to' : 'https://github.com/tfrommen/linked-taxonomies/issues',
